...
${argumentEssay}
  ...
  try {
    ...
    cleaned = cleaned.replace(
      /^(Clarity|Logic|Development|Grammar|Total Score|Feedback|Feedback on Mistakes|Suggestion for Improvement|Suggestions for Improvement|Improvement suggestions:):/gm,
      '<strong>$1:</strong>'
    );
