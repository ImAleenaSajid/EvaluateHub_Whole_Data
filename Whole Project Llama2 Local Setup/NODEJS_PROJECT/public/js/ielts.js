...
submitBtn.addEventListener("click", async () => {
  ...
  try {
    ...
    /^(Task Response|Coherence and Cohesion|Lexical Resource|Grammar|Overall Band Score|Feedback|Feedback on Mistakes|Suggestion for Improvement|Suggestions for Improvement|Improvement suggestions:):/gm,
    '<strong>$1:</strong>'
    );
