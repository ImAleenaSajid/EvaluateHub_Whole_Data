...
submitBtn.addEventListener("click", async () => {
  ...
  try {
    ...
    cleaned = cleaned.replace(
      /^(Thesis|Support|Organization|Evidence|Language Use|Total Score|Feedback|Feedback on Mistakes|Suggestions for Improvement|Suggestion for Improvement|Improvement suggestions:):/gm,
      '<strong>$1:</strong>'
    );
